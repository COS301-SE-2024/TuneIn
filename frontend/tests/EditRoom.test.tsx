...
jest.mock('expo-router', () => ({
  useRouter: jest.fn(),
  useLocalSearchParams: jest.fn().mockReturnValue({ room: JSON.stringify({ name: 'Room Name', songName: 'Song Name', artistName: 'Artist Name', description: 'Description of the room', tags: ['tag1', 'tag2'] }) }),
}));
...
describe('EditRoom', () => {
  it('renders correctly with valid room data', () => {
    ...
    (useLocalSearchParams as jest.Mock).mockReturnValue({ room: JSON.stringify(room) });
