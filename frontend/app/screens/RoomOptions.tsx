...
import { FontAwesome5, MaterialIcons, MaterialCommunityIcons, Entypo, FontAwesome } from '@expo/vector-icons';
...
const RoomOptions = ({}) => {
  ...
  const room = {
    name: "Cool Jazz",
    host: "John Doe",
    image: "https://images.pexels.com/photos/3792581/pexels-photo-3792581.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity style={styles.playlistContainer} onPress={goToPlaylist} >
        <View style={styles.buttonContent}>
          <MaterialCommunityIcons name="playlist-play" size={24} color="black" />
