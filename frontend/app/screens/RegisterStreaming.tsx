...
const RegisterStreamingScreen: React.FC = () => {
  ...
  const navigateToLogin = () => {
    router.push('screens/LoginStreaming');
  };

  const navigateToOther = () => {
    router.push('screens/RegisterOther');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.welcomeText}>Join the Fastest Growing Listening Community</Text>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity style={[styles.button, styles.otherButton]}>
          <Icon name="youtube-play" size={24} color="#000" style={styles.icon} />
        ...
        <TouchableOpacity style={[styles.button, styles.otherButton]} onPress={navigateToOther}>
      ...
      <TouchableOpacity style={styles.registerContainer} onPress={navigateToLogin}>
        ...
        Already have an account? <Text style={styles.registerBoldText}>Login Now</Text>
        </Text>
      </TouchableOpacity>
    </View>
  );
