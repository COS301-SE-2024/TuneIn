				...
				<View style={styles.container}>
					...
					<View style={styles.cardsContainer}>
						<MetricsCard
							...
							percentage={keymetrics?.unique_visitors.percentage_change.toString()?? "0"}
						/>
						<MetricsCard
							title="Returning Visitors"
							number={keymetrics?.returning_visitors.count.toString()?? "0"}
							percentage={keymetrics?.returning_visitors.percentage_change.toString()?? "0"}
						/>
					</View>
					<View style={styles.cardsContainer}>
						<MetricsCard
							title="Average Session Duration"
							number={secondsToString(keymetrics?.average_session_duration.duration?? 0)}
							percentage={keymetrics?.average_session_duration.percentage_change.toString()?? "0"}
						/>
					</View>
					<View style={styles.cardsContainer}>
						<PieChartCard returningVisitors={keymetrics?.returning_visitors.count?? 0} newVisitors={
							(keymetrics?.unique_visitors.count?? 0) - (keymetrics?.returning_visitors.count?? 0)
						} />
					</View>
				</View>
			</ScrollView>
