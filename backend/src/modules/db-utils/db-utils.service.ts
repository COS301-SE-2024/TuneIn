...
import { UpdateUserProfileDto as UpdateUserProfileDtoInterface } from "../profile/dto/updateuserprofile.dto";

interface UpdateUserProfileDto extends UpdateUserProfileDtoInterface {
  [key: string]: any;
}
