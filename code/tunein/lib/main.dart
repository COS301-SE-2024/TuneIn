...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/': (context) => CreateRoomScreen(), // Set the default route
        Routes.welcome: (context) => WelcomePage(), // Register the welcome route
        ...
        Routes.createRoom: (context) => CreateRoomScreen(), // Register the createRoom route
        Routes.roomDetails: (context) => RoomDetailsScreen(), // Register the roomDetails route
      },
