...
import '../widgets/my_toggle_widget.dart';
          ...
          children: [
            Center(
              child: MyToggleWidget(
                ...
                onChanged: (isFirstSelected) {
                  print(isFirstSelected ? 'Permanent selected' : 'Temporary selected');
                },
              ),
            ),
            SizedBox(height: 30),
            Center(
              child: MyToggleWidget(
                ...
                onChanged: (isFirstSelected) {
                  print(isFirstSelected ? 'Public selected' : 'Private selected');
                },
              ),
            ),
            SizedBox(height: 40),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.pushNamed(context, Routes.roomDetails); // Replace with your actual route
                },
