      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 20), // Added some space between the carousel and button
            _buildRoomList(
              context,
              title: 'Picks for You',
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemExtent: MediaQuery.of(context).size.width * 0.85, // Adjust as needed
  ...
  List<RoomCard> _getRecentRooms() {
    return [
      ...
      RoomCard(
        ...
        username: 'jane_doe',
        userProfile: 'https://img.freepik.com/free-photo/smiling-young-man-wearing-sunglasses_171337-18683.jpg',
        backgroundImage: 'https://images.pexels.com/photos/1449799/pexels-photo-1449799.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      ...
      RoomCard(
        ...
        backgroundImage: 'https://example.com/background_images/relaxing_beats.jpg',
  ...
  List<RoomCard> _getPicksForYou() {
    return [
      RoomCard(
        ...
        username: 'alice',
        userProfile: 'https://img.freepik.com/free-photo/beautiful-woman-face-close-up-young-girl-model-with-perfect-clean-skin-isolated-white-wall-studio-natural-makeup-beauty-treatment-spa-wellness_155003-14608.jpg',
        backgroundImage: 'https://images.pexels.com/photos/257360/pexels-photo-257360.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      ...
      RoomCard(
        ...
        backgroundImage: 'https://example.com/background_images/groovy_hits.jpg',
      ...
      RoomCard(
        ...
        backgroundImage: 'https://example.com/background_images/study_vibes.jpg',
